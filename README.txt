For this project, I was tasked with creating an API that could handle large amounts of requests -
and supply product data for an e-commerce website. 

The data source I was given was millions of lines of CSV's-
in order to utilize the data I had to transfer it from the CSV files into a database that could be queried. 
To do this, I had to create an ETL pipeline. 
